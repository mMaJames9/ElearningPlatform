            ...
            <div class="modal-body p-0">
                <div class="rounded-top-lg py-3 ps-4 pe-6 bg-light">
                    <h4 class="mb-1" id="title">
                        <img class="my-2" src="{{ asset('assets/img/icons/spot-illustrations/exam-succes.png') }}" alt="logo" width="150" />
                    </h4>
                </div>
                <form id="subForm" method="POST" action="{{ route('plans.update', 1) }}" onsubmit="ShowLoading()">
                    ...
                    <div class="p-4 pb-0">
                        ...
                        <div class="mb-3">
                            ...
                            <span class="fs--1 text-warning">{{__('Make sure your account balance is sufficient before initiating the payment. Otherwise the request will fail.')}}</span>
                        </div>
                        <div class="mb-3">
