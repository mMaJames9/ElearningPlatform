                                    ...
                                    <div class="p-4 p-md-5 flex-grow-1">
                                        ...
                                        <form class="mt-3" method="POST" action="{{ route('password.confirm') }}">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input id="password" class="form-control @error('password') is-invalid @enderror" type="password" name="password" required autocomplete="current-password" placeholder="{{__('********')}}" />
                                            ...
                                            <button class="btn btn-primary d-block w-100 mt-3" type="submit" name="submit">{{ __('Confirm') }}</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
