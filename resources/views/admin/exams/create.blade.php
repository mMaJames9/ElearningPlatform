                ...
                <div class="card-body">
                    ...
                    <form class="forms-sample" method="POST" action="{{ route('exams.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="js-example-basic-single form-select @error('exam_section') is-invalid @enderror" data-width="100%" id="exam_section" name="exam_section" :value="old('exam_section')" required autofocus>
